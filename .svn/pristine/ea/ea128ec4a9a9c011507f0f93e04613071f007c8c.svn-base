 ...
 * @date 2019-04-30
 */
public interface ZhongzServiceTypeMapper 
{
	/**
     * 查询服务类型信息
     * 
     ...
     * @return 结果
     */
	public int deleteZhongzServiceTypeById(String id);
	...
	public int updateZhongzServiceTypeByIds(Map<String, Object> params);
