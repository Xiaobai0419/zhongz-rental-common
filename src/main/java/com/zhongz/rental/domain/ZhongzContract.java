...
public class ZhongzContract extends BaseEntity
{
	...
	@ApiModelProperty(value="租住房间朝向", dataType="Integer")
	private Integer roomDirection;
	/** 承租人id */
	@ApiModelProperty(value="承租人id", dataType="String")
	private String tenantId;
	/** 委托代理人id */
	@ApiModelProperty(value="委托代理人", dataType="String")
	...
	@ApiModelProperty(value="证件类型名称", dataType="String")
	...
	@ApiModelProperty(value="关联订单", dataType="ZhongzOrder")
	private ZhongzOrder order;

	public ZhongzOrder getOrder() {
		return order;
	}
	...
	public void setOrder(ZhongzOrder order) {
		this.order = order;
	}
	...
	public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("entrustedAgent", getEntrustedAgent())
